...
const About = () => {
    ...
    return (
        <Container id={"about"} title={"About Me"}>
            <div className="flex flex-col md:flex-row p-10 w-[90%]  justify-center items-center mx-auto">
                ...
                <div className="" >
                    ...
                    <p className="font-semibold text-2xl" data-aos-delay="500" data-aos="fade-up">Currently attempting to switch careers from the industrial sector to becoming a web developer, with a strong interest in learning and trying new things, currently possess skills in several programming languages. Committed to continually improving the skills and seeking opportunities to contribute to web development projects that come the way. And also has experience in managing personal projects and feel prepared to take on the challenges of a web developer role.</p>
                </div>
            </div>
        </Container>
